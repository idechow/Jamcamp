...
- User Authentication 
  ...
  * Users can sign in using the demo log in<br/>
- Modals
  ...
  * Implemented modals for user auth as well as other pop ups.<br/>
- Profile Page (Editable)
  ...
  * Profile page edit button insights a change in the Redux state to open or close the edit function within the profile page.<br/>
- Profile Page (Grid)
